...
if (($_POST)) {
    ...
    if (empty($usuario) || empty($clave)) {
       ...
       $mensaje =  "¡Hay campos vacios en el formulario!";
		...
		if($login[0]['id_cliente'] > 0){

        if($login[0]['id_perfil'] != '14'){

		    $_SESSION['id_cliente'] = $login[0]['id_cliente'];
        ...
        echo ("<script LANGUAGE='JavaScript'>
                  ...
                  echo ("<script LANGUAGE='JavaScript'>
                    ...
                    window.location.href='Vista/inicioPropietarios.php';
