...
if($_POST){
	...
	$motivo = $motivo.' - '.$hoy;
	$sql = "update pareto_actividades set fecha_modificacion = '$hoy', novedad = '$motivo' where id = '$id'";
	$insert = new base_datos;
	$insert->connect();
	$insert->query($sql);
	echo ("<SCRIPT LANGUAGE='JavaScript'>
	alert('Novedad Agregada Correctamente');
	window.location.href='consultar_pareto.php?id=".$idp."';
	</SCRIPT>");
}
?>
<!DOCTYPE html>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-icon_document_alt"></i> Agregar Novedad</h3>
           </div>
        </div>
