...
$contenido=$querys->invitacionestodas($_SESSION['idus']);
      ...
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <section class="panel">
              <header align="right">
				<a href="mis_solicitudes.php"><button class="btn btn-primary">Mis Invitaciones</button></a>
              </header>
...
<th>Horario</th>
                  ...
                  <tbody>
					...
					<td><?php $actividad = $querys->actividad_id2($cont['id_actividad']); echo $actividad[0]['fecha']; ?></td>
					  <td><?php echo $actividad[0]['hora'].' - '.$actividad[0]['hora_fin'];?></td>
                      <td><?php $user = $querys->usuarioid($cont['id_anfitrion']); echo $user[0]['nombre'];?></td>
					  <td><?php echo $actividad[0]['descripcion'];?></td>
					  <td>
						<?php
						if($cont['estado'] == 'P'){
							$estado = 'Pendiente';
						} else if ($cont['estado'] == 'A') {
							$estado = 'Aceptada';
						} else if ($cont['estado'] == 'R') {
							$estado = 'Rechazada';
						}
						echo $estado;
						?>
					  ...
					  <td>
					 <?php if($cont['estado'] == 'P'){ ?>
						<a href="aceptar_invitacion.php?id=<?php echo $cont['id_invitacion'];?>">
						<button class="btn btn-success btn-xs">Aceptar</button>
						</a>
						<a href="rechazar_invitacion.php?id=<?php echo $cont['id_invitacion'];?>">
