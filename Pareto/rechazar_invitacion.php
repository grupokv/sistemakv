...
if($_POST){
	...
	$motivo = $motivo.' - '.$hoy;
	$sql = "update invitaciones set estado = 'R', respuesta = '$motivo' where id_invitacion = '$idinv'";
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-icon_document_alt"></i> Motivo Rechazo Invitacion</h3>
           </div>
        </div>
                ...
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="post" action="">
					...
					<div class="form-group ">
                      <label for="nombre" class="control-label col-lg-2">Respuesta <span class="required">*</span></label>
                      <div class="col-lg-10">
