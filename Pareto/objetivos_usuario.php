  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-icon_document_alt"></i> Objetivos Por Usuario</h3>
           </div>
        </div>
          ...
          <div class="col-md-12 portlets">
            ...
            <div class="panel panel-default">
			  ...
			  <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="post" action="historial_objetivos_usuario.php">
