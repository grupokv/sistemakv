...
if($_POST){
	...
	$perfil = $_POST['perfil'];
	$pass = $_POST['password'];
	$area1 = $querys->cargoid($cargo);
	$area = $area1[0]['id_area'];
	
	$hoy = date('Y-m-d H:i:s');
	$sql = "INSERT INTO usuario(nombre,cedula,password,id_cargo,id_area,id_perfil,ultimo_ingreso,estado) VALUES ('$nombre','$num','$pass','$cargo','$area','$perfil','$hoy', 1)";
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-icon_document_alt"></i> Nuevo Usuario</h3>
           </div>
        </div>
					...
					<div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <select class=" form-control" id="perfil" name="perfil" required >
							...
							<option value="<?php echo $tp1['id'];?>"><?php echo $tp1['nombre'];?></option>
							<?php } ?>
						</select>
                      </div>
                    </div>
