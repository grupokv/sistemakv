...
$actividades = $querys->actividadesTodasPareto($idpareto);
$conteo = $querys->conteoactividadesTodasPareto($idpareto);
//print_r($actividades);
?>
<!DOCTYPE html>
<html lang="es">
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-icon_document_alt"></i> Pareto Actual</h3>
           </div>
        </div>
          ...
          <div class="col-lg-12">
            <section class="panel">
			  <header align="right">
				...
				<a href="pareto_proximo.php"><button class="btn btn-primary">Pareto Siguiente Semana</button></a>
              </header>
			  ...
			  <div class="table-responsive">
                <table class="table">
				  <thead>
					<tr><th colspan="5"><b><?php $det_tipo = $querys->tiposactid($act['id_tipoactividad']); echo $det_tipo[0]['detalle'];?></b></th></tr>
                    <tr>
                      <th>#</th>
                      <th>Descripción</th>
					  <th>Fecha</th>
