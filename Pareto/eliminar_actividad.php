...
if($_POST){
	...
	$sql = "update pareto_actividades set activo = 'I', fecha_modificacion = '$hoy', novedad = '$motivo' where id = '$id'";
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-icon_document_alt"></i> Eliminar Actividad</h3>
           </div>
        </div>
                ...
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="post" action="">
					...
					<div class="form-group ">
                      <label for="nombre" class="control-label col-lg-2">Motivo <span class="required">*</span></label>
                      <div class="col-lg-10">
