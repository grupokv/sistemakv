    ...
    <form class="login-form" action="validar.php" method="post">
      <div class="login-wrap">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Usuario" autofocus name="user" id="user" required>
        </div>
        <div class="input-group">
        ...
        <a href="../" class="btn btn-primary btn-lg btn-block" style="color: #fff !important;">Regresar</a>
      </div>
    </form>
