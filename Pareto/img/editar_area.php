...
if($_POST){
	...
	$sql = "update area set nombre_area = '$nombre' where id_area = '$id'";
	$insert = new base_datos;
	$insert->connect();
	$insert->query($sql);
	echo ("<SCRIPT LANGUAGE='JavaScript'>
	alert('Area Editada Correctamente');
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-icon_document_alt"></i> Editar Area</h3>
           </div>
        </div>
            ...
            <div class="panel panel-default">
			  ...
			  <div class="panel-body">
                <div class="form">
				  ...
				  <input type="hidden" value="<?php echo $contenido[0]['id_area'];?>" name="id"/>
                    <div class="form-group ">
                      <label for="nombre" class="control-label col-lg-2">Nombre <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="nombre" name="nombre" type="text" required value="<?php echo $contenido[0]['nombre_area'];?>" />
                      </div>
                    </div>
