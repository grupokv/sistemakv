              ...
              <div class="col-md-12 portlets">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <header align="right">
                        <button class="btn btn-primary" id="btnAdd" style="margin: 0px; padding: 0px 4px 0px 4px;" onclick="mas()"><span class="fa fa-plus"></span></button>
                    </header>
  ...
  <script src="../Recursos/js/fullcalendar.min.js"></script>
    ...
    <script type="text/javascript">
        $( function() {
          ...
          num = 1;
          function mas(){
            var toClone = $('#duplicar');
              var toCloneClone = toClone.clone().val(toClone.val());


               toCloneClone.attr("id", 'duplicar'+ num);

              $("#contenedor").append(toCloneClone);  
              num++;
          }
    </script>
