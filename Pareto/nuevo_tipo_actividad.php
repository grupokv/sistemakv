...
if($_POST){
	...
	$nombre = $_POST['nombre'];
	$sql = "insert into tipo_actividad(detalle) values ('$nombre')";
	$insert = new base_datos;
	$insert->connect();
	$insert->query($sql);
	echo ("<SCRIPT LANGUAGE='JavaScript'>
	alert('Tipo Actividad Agregado Correctamente');
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-icon_document_alt"></i> Nuevo Tipo de Actividad</h3>
           </div>
        </div>
