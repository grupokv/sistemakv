...
$uspareto = $querys->paretoid($idpareto);
$us = $uspareto[0]['id_usuario'];
...
<script>
function modal(id){
	$('.modal-body').load('contenido_modal_cerrado.php?id='+id,function(){
          ...
          <div class="col-md-12 portlets">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
			          ...
			          <form action="paretos_usuario.php" method="POST" style="padding: 8px;">
                    <button class="btn btn-info" type="submit">Volver</button>

                    <a href="exportarParetoUsuario.php?id=<?php echo $idpareto; ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Exportar Excel</a>
			          </form>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
					  ...
					  <td><?php if ($act1['aplica_objetivo'] == 'S'){ ?>
					  <font title="<?php $detalle = $querys->obj_especificosid2($act1['id_objetivo']); echo $detalle[0]['descripcion'] ;?>">SI</font> 
					  <?php } else { ?>
					  NO
					  <?php } ?>
					  </td>
                      ...
                      <td>
					  <?php $sub = $querys->actividadespadre($act1['id']); if (count($sub) > 0 ){ ?>
					  <button type="button" class="btn btn-success btn-xs" onclick="modal('<?php echo $act1["id"];?>')"><b>+</b></button>
					  <?php } ?>
...
<td><?php if ($act2['aplica_objetivo'] == 'S'){ ?>
					  <font title="<?php $detalle = $querys->obj_especificosid2($act2['id_objetivo']); echo $detalle[0]['descripcion'] ;?>">SI</font> 
					  <?php } else { ?>
					  NO
					  <?php } ?>
					  </td>
                      ...
                      <td>
					  <?php $sub = $querys->actividadespadre($act2['id']); if (count($sub) > 0 ){ ?>
					  <button type="button" class="btn btn-success btn-xs" onclick="modal('<?php echo $act2["id"];?>')"><b>+</b></button>
					  <?php } ?>
...
<td><?php if ($act3['aplica_objetivo'] == 'S'){ ?>
					  <font title="<?php $detalle = $querys->obj_especificosid2($act3['id_objetivo']); echo $detalle[0]['descripcion'] ;?>">SI</font> 
					  <?php } else { ?>
					  NO
					  <?php } ?>
					  </td>
                      ...
                      <td>
					  <?php $sub = $querys->actividadespadre($act3['id']); if (count($sub) > 0 ){ ?>
					  <button type="button" class="btn btn-success btn-xs" onclick="modal('<?php echo $act3["id"];?>')"><b>+</b></button>
					  <?php } ?>
