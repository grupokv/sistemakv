  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-icon_document_alt"></i> Perfiles</h3>
           </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <section class="panel">
              <header align="right">
                <a href="nuevo_perfil.php"><button class="btn btn-success">Agregar</button></a>
              </header>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
						<a href="editar_perfil.php?id=<?php echo $cont['id'];?>">
