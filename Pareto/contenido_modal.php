...
<section class="panel">
<header align="right">
	<?php if ($actividadid[0]['estado'] == 0){ ?>
		<button class="btn btn-success" onclick="modal2('<?php echo $idp;?>')">Agregar</button></a>
	<?php } ?>
</header>
...
<td>
	<a href="eliminar_actividad.php?id=<?php echo $acti1['id'];?>"><button type="button" class="btn btn-danger btn-xs"><b>X</b></button></a>
</td>
</tr>
<?php $i++; } ?>
<?php } else { ?>
