    ...
    <!--**************************--->
        ...
        <section class="home_content">  
            ...
            <div class="notice notice-sistemakv">
                <strong><i class="fa fa-car mr-3" style="font-size: 2rem;"></i>FIRMA RECIBIDO INSPECCIÓN VEHICULAR</strong>
            </div>

            <section class="form-usuarios">
                <div class="formulario mb-5">
                    <form action="../Controlador/firmaRecibidoInspeccionVehicular.php" id="signature-form" method="POST" enctype="multipart/form-data" onsubmit="return validar()">
                            <!-- INFORMACION BASICA-->
                                <div id="tabs-1" class="p-4">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="input">
                                            <input type="text" class="form-control form-control-sm" name="nombre_recibe" id="nombre_recibe" required="required" >
                                        </div>              
                                    </div>
