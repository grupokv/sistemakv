    ...
    <!-- CONTENIDO -->
        ...
        <section class="home_content">
            ...
            <div class="notice notice-sistemakv">
              <strong><i class="fa fa-file-text-o mr-3" style="font-size: 2rem;"></i><b style="font-size:1.3rem;">REGISTRAR EXTRACTOS</b></strong>
            </div>
            ...
            <section class="form-usuarios mb-5">
                <div class="col-10 formulario mb-5">
                    ...
                    <!-- Formulario -->
                    <form method="POST" action="../Controlador/registrarFuec1.php" class="p-4">
                            ...
                            <!-- CLIENTE -->
                                <div class="row mt-4 mb-4 ">
                                    ...
                                    <div class="input">    
                                        <select class="form-control form-control-sm selectpicker" data-live-search="true" name="cliente" id="cliente" onchange="listar_contratos();">
                            ...
                            <!-- CONTRATO -->
                                <div class="row mt-4 mb-4 ">
                                    ...
                                    <div class="input">    
                                       <select class="form-control form-control-sm" name="contrato" id="contrato"  onchange="listar_vehiculos(); validarContrato(this.value);" required="required">
                                        </select>
                                    </div>
                                </div>
                            ...
                            <!-- VEHICULO -->
                                <div class="row mt-4 mb-4 ">
                                    ...
                                    <div class="input">    
                                       <select class="form-control form-control-sm" data-live-search="true" name="vehiculo" id="vehiculo" onchange="validarDocsConductor(this.value); validar_datos(); veh(this.value); validarDocsVehiculoAlert(this.value);">
                                       </select>
                                    </div>
                                </div>
                            ...
                            <!-- ORIGEN -->
                                <div class="row mt-4 mb-4 ">
                                    ...
                                    <div class="input">    
                                        <select class="form-control form-control-sm selectpicker" data-live-search="true" name="origen" id="origen" onchange="validar_datos();">
                                            <option value="">SELECCIONAR</option>
                                        ...
                                        <button type="button" class="btn btn-xs btn-outline-success m-1" onclick="cargar_origen()" style="margin: 0px; padding: 0px 4px 0px 4px;"><i class="fa fa-refresh"></i></button>
                                    </div>
                                </div>
                            ...
                            <!-- DESTINO -->
                                <div class="row mt-4 mb-4 " id="destinoCiudades" style="display: none;">
                                    ...
                                    <div class="input">    
                                        <select class="form-control form-control-sm selectpicker" data-live-search="true" name="destinoCiudad" id="destino" onchange="validar_datos();">
                                            <option value="">SELECCIONAR </option>
                                       ...
                                       <button type="button" class="btn btn-xs btn-outline-success m-1" onclick="cargar_destino()" style="margin: 0px; padding: 0px 4px 0px 4px;"><i class="fa fa-refresh"></i></button>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4 mb-4 " id="destinoRutaText" style="display: none;">
                                    ...
                                    <div class="input">    
                                        <textarea class="form-control form-control-sm" name="destinoRuta" id="destino" onchange="validar_datos();"></textarea>
                                    </div>
                                </div>
                            ...
                            <!-- FECHA FINAL -->
                                <div class="row mt-4 mb-4">
                                    ...
                                    <div class="input">    
                                       <input type="text" class="form-control form-control-sm" name="fecha_inicial" id="datepicker1" placeholder="SELECCIONAR FECHA"/>
                                    </div>
                                </div>
                            ...
                            <!-- FECHA FINAL -->
                                <div class="row mt-4 mb-4 " id="fecha_fuec" style="display:none">
                                    ...
                                    <div class="input">    
                                       <input type="text" class="form-control form-control-sm" name="fecha_final" id="datepicker" placeholder="SELECCIONAR FECHA" />
                                    </div>
                                </div>
                            ...
                            <!-- RESPONSABLE CONTRATO -->
                                <div class="row mt-4 mb-4 ">
                                    ...
                                    <div class="input">    
                                       <input type="text" class="form-control form-control-sm" name="nombre_responsable" id="nombre_responsable" onkeyup="validar_datos()" />
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4 mb-4 ">
                                    ...
                                    <div class="input">    
                                       <input type="text" class="form-control form-control-sm" name="num_responsable" id="num_responsable" onkeyup="validar_datos()" />
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4 mb-4 ">
                                    ...
                                    <div class="input">    
                                       <input type="text" class="form-control form-control-sm" name="dir_responsable" id="dir_responsable" onkeyup="validar_datos()" />
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4 mb-4 ">
                                    ...
                                    <div class="input">    
                                       <input type="text" class="form-control form-control-sm" name="tel_responsable" id="tel_responsable" onkeyup="validar_datos()" />
                                    </div>
                                </div>
                            ...
                            <section class="col-12 mt-5 d-flex justify-content-center">
                                ...
                                <!-- CANCELAR REGISTRO -->
                                    <a href="fuec.php" class="btn btn-outline-danger col-3 mr-3">Cancelar</a>
                                
                                <!-- VISTA PRELIMINAR -->
                                    <button type="button" id="boton_vista" style="display:none" class="btn btn-outline-info  col-3 mr-3" onclick="vista_preliminar()">Vista Preliminar</button>
