<?php
$filename = 'informe_base_completa.xls';
...
<table  id="dataT" class="table table-hover table-sm display tablesaw tablesaw-columntoggle" data-tablesaw-mode="columntoggle" data-tablesaw-minimap style="width:100%">
              ...
              <!-- CONDUCTORES -->
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">NOMBRE CONDUCTOR(ES)</th>
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">NUM DOCUMENTO</th>
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">FECHA VEN. LICENCIA</th>
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">CATEGORIA</th>
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">RH</th>
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">ESTADO CIVIL</th>
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">TELEFONO 1</th>
              <!-- FIN CONDUCTORES -->
            ...
            <?php foreach ($listarV as $lv){ ?>
              ...
              <tr>
                  ...
                  <td>
                    <?php $i = 0; ?>
                    <?php foreach ($cant_v as $cpv){ ?>
                        <?php  if ($i == (count($cant_v) - 1)){ ?>
                            <?php echo $cpv['nombre_conductor'];?>
                        <?php } else { ?>
                            <?php echo $cpv['nombre_conductor'] . ', '; ?>
                        <?php } ?>
                  ...
                  <td>
                    <?php $a = 0; ?>
                    <?php foreach ($cant_v as $cpv){ ?>
                        <?php  if ($a == (count($cant_v) - 1)){ ?>
                            <?php echo $cpv['numero_documento_conductor'];?>
                        <?php } else { ?>
                            <?php echo $cpv['numero_documento_conductor'] . ', '; ?>
                        <?php } ?>
                  ...
                  <td>
                    ...
                    <?php foreach ($cant_v as $cpv){ ?>
                        <?php  if ($a == (count($cant_v) - 1)){ ?>
                            <?php echo $cpv['fecha_vencimiento_licencia'];?>
                        <?php } else { ?>
                            <?php echo $cpv['fecha_vencimiento_licencia'] . ', '; ?>
                        <?php } ?>
                  ...
                  <td>
                    ...
                    <?php foreach ($cant_v as $cpv){ ?>
                        <?php  if ($a == (count($cant_v) - 1)){ ?>
                            <?php echo $cpv['categoria_licencia'];?>
                        <?php } else { ?>
                            <?php echo $cpv['categoria_licencia'] . ', '; ?>
                        <?php } ?>
                  ...
                  <td>
                    ...
                    <?php foreach ($cant_v as $cpv){ ?>
                        <?php  if ($a == (count($cant_v) - 1)){ ?>
                          <?php if ($cpv['telefono1'] == ''){ ?>
                              <?php echo "SIN REGISTRO"?>
                          <?php } else { ?>
                            <?php echo $cpv['telefono1']; ?>
                          <?php } ?>
