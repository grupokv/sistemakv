	...
	<td style="font-weight:bold; color:#989898;">
		...
		<div class="form-group">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					<td width="60%">
						<label class="form-check-label" for="prueba_covid">¿Descanso adecuadamente en las ultimas doce horas?</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid1" value="S" name="prueba_covid[]" required="required" <?php if($datos_salud[0]['horas_descanso'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid1">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid2" value="N" name="prueba_covid[]" required="required" <?php if($datos_salud[0]['horas_descanso'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid2">NO</label>
					</td>
				</tr>
			</table>
		...
		<div class="form-group" style="display: none;" id="ConsumoMedicamento">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					...
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid1" value="S" name="medicamento_suenio[]" required="required" <?php if($datos_salud[0]['medicamento_suenio'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid1">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid2" value="N" name="medicamento_suenio[]" required="required" <?php if($datos_salud[0]['medicamento_suenio'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid2">NO</label>
					</td>
				</tr>
			</table>
		...
		<div class="form-group">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					<td width="60%">
						<label class="form-check-label" for="prueba_covid">¿Se siente en condiciones para trabajar?</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid1" value="S" name="condicion_trabajo[]" required="required" <?php if($datos_salud[0]['condicion_trabajo'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid1">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid2" value="N" name="condicion_trabajo[]" required="required" <?php if($datos_salud[0]['condicion_trabajo'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid2">NO</label>
					</td>
				</tr>
			</table>
...
function medicamento(valor){
	if(valor == 'S'){
		document.getElementById('ConsumoMedicamento').style.display = 'block';
	}else{
		document.getElementById('ConsumoMedicamento').style.display = 'none';
	}
}
