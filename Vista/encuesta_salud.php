...
$busqueda = $salud->buscarPorUsuario($usuario,$fecha);
$cant = count($busqueda);
...
if($cant > 0){
	...
	$datos_salud = $salud->listarUltimaPorUsuario($usuario);
...
<head>    
<meta charset="utf-8">	
<title>SistemaKV | Encuesta Salud</title>    
...
<form action="../Controlador/guardar_encuesta_salud.php" method="post">
	...
	<td style="font-weight:bold; color:#989898;">
		...
		<div class="form-group">
			...
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				...
				<tr>
					<td width="60%">
						<label class="form-check-label" for="contacto_estrecho">En los ultimos 14 dias ha tenido contacto estrecho (por mas de 15 minutos, a menos de 2 metros y sin usar elementos de proteccion personal) con alguien en proceso de diagnostico o confirmado de COVID-19</label>
					</td>
					<td width="20%">
		...
		<div class="form-group">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					<td width="60%">
						<label class="form-check-label" for="aplicacionVacuna">Se ha aplicado alguna vacuna contra el COVID-19? </label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="aplicacionVacuna1" value="S" name="aplicacionVacuna[]" required="required" <?php if($datos_salud[0]['aplicacion_vacuna'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="aplicacionVacuna1">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="aplicacionVacuna2"  value="N" name="aplicacionVacuna[]" required="required" <?php if($datos_salud[0]['aplicacion_vacuna'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="aplicacionVacuna2">NO</label>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="form-group">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					<td width="60%">
						<label class="form-check-label" for="horas_descanso">¿Descanso adecuadamente en las ultimas doce horas?</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="horas_descanso" value="S" name="horas_descanso[]" required="required" <?php if($datos_salud[0]['horas_descanso'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="horas_descanso2">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="horas_descanso2" value="N" name="horas_descanso[]" required="required" <?php if($datos_salud[0]['horas_descanso'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid2">NO</label>
					</td>
				</tr>
			</table>
		...
		<div class="form-group">
			<label for="horas_totales_suenio">¿Cuántas horas durmio duranrte las ultimas doce horas?</label>
			<input type="text" class="form-control form-control-sm" id="horas_totales_suenio" name="horas_totales_suenio" required="required" placeholder="Horas de Sueño" value="<?php echo $datos_salud[0]['horas_totales_suenio'];?>">
		</div>
		...
		<div class="form-group">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					<td width="60%">
						<label class="form-check-label" for="prueba_covid">¿Se siente fatigado?</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="fatiga" value="S" name="fatiga[]" required="required" <?php if($datos_salud[0]['fatiga'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="fatiga">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="fatiga2" value="N" name="fatiga[]" required="required" <?php if($datos_salud[0]['fatiga'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="fatiga2">NO</label>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="form-group">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					<td width="60%">
						<label class="form-check-label" for="situacion_personal">¿Tiene alguna situación personal que le ha limitado dormir/descansar apropiadamente en los ultimos dias?</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="situacion_personal" value="S" name="situacion_personal[]" required="required" <?php if($datos_salud[0]['situacion_personal'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="situacion_personal">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="situacion_personal2" value="N" name="situacion_personal[]" required="required" <?php if($datos_salud[0]['situacion_personal'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="situacion_personal2">NO</label>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="form-group">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					<td width="60%">
						<label class="form-check-label" for="prueba_covid">¿Está tomando algun medicamento?</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid1" value="S" onclick="medicamento(this.value);" name="medicamento[]" required="required" <?php if($datos_salud[0]['medicamento'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid1">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid2" value="N" onclick="medicamento(this.value);" name="medicamento[]" required="required" <?php if($datos_salud[0]['medicamento'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid2">NO</label>
					</td>
				</tr>
			</table>
		...
		<div class="form-group" style="display: none;" id="ConsumoMedicamento">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					<td width="60%">
						<label class="form-check-label" for="prueba_covid">Siente que el medicamento le produce sueño</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid1" value="S" name="medicamento_suenio[]" <?php if($datos_salud[0]['medicamento_suenio'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid1">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="prueba_covid2" value="N" name="medicamento_suenio[]" <?php if($datos_salud[0]['medicamento_suenio'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid2">NO</label>
					</td>
				</tr>
			</table>
		...
		<div class="form-group">
			<table width="100%" class="table table-condensed" style="font-weight:bold; color:#989898;">
				<tr>
					<td width="60%">
						<label class="form-check-label" for="condicion_trabajo">¿Se siente en condiciones para trabajar?</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="condicion_trabajo" value="S" name="condicion_trabajo[]" required="required" <?php if($datos_salud[0]['condicion_trabajo'] == 'S'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid1">SI</label>
					</td>
					<td width="20%">
						<input type="radio" class="form-check-input" id="condicion_trabajo" value="N" name="condicion_trabajo[]" required="required" <?php if($datos_salud[0]['condicion_trabajo'] == 'N'){ ?> checked="checked" <?php } ?> >
						<label class="form-check-label" for="prueba_covid2">NO</label>
					</td>
				</tr>
			</table>
				...
				<tr>
					<td colspan="2" style="text-align:justify">
						<label class="form-check-label" for="exampleCheck1">
							<b class="text-center">Si presenta signos de sueño o fatiga,por favor contacte a su coordinador o supervisor antes de conducir y dele a conocer su caso.Su vida y la de terceros pueden estar en riesgo.</b>
						</label>
					</td>
				</tr>
			</table>
