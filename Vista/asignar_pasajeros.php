...
<body>
    ...
    <div aria-label="breadcrumb" class="mt-1"> 
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Asignación Pasajeros</li>
         </ol>
    </div>
                ...
                <?php foreach ($listarV as $lv){ ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <!--Consultar-->
                             <a href="asignacion_pasajeros.php?idv=<?php echo $lv['id_vehiculo'];?>" class="btn btn-outline-success"  style="margin: 0px; padding: 0px 4px 0px 4px;">
                                  ...
                                  <div class="modal-dialog " role="document">
                                    <div class="modal-content f-flex justify-content-center">
                                      ...
                                      <div class="modal-footer">
                                       ...
                                       <a href="actualizarVehiculo.php?id_vehiculo=<?php echo $lv['id_vehiulo'] ?>" class="btn btn-outline-info"> Actualizar</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
