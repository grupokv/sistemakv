...
$redireccion = 'usuario_cliente.php';
$icono = 'fa fa-user-o';
...
$usuario = new Usuario();
$datos = $usuario->listarUsuarioPorId($id);
...
<head>
    <meta charset="utf-8">
    <title>SistemaKV | Actualizar usuario cliente</title>
...
<body>
    ...
    <div aria-label="breadcrumb" class="mt-1"> 
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item " aria-current="page"><a href="usuarios_clientes.php">Usuarios Clientes</a></li>
    ...
    <section class="form-usuarios mt-1">
        <div class="formulario">
            ...
            <form method="POST" action="../Controlador/actualizarUsuarioCliente.php">
                    ...
                    <hr>
                        ...
                        <!-- CORREO ELECTRONICO -->
                          <div class="row mb-4 ">
                              ...
                              <div class="input">    
                                  <input type="text" name="correo_electronico" id="correo_electronico" class="form-control" value="<?php echo $datos[0]['correo_electronico'];?>">
                              </div>
                          </div>
                        ...
                        <!-- NUMERO DE DOCUMENTO -->
                          <div class="row mb-4 ">
                              ...
                              <div class="input">    
                                  <input type="text" name="numero_documento" id="numero_documento"  class="form-control"  value="<?php echo $datos[0]['usuario'];?>">
                              </div>
                          </div>
                              ...
                              <div class="input">
                                  <select class="form-control selectpicker" data-live-search="true" name="id_cliente" id="id_cliente" onchange="cargarDatos(this.value)">
                                      ...
                                      <?php foreach ($listarC as $lc){ ?>
                                        <option value="<?php echo $lc['id_cliente'] ?>" <?php if($lc['id_cliente'] == $datos[0]['id_cliente']){ ?> selected="selected" <?php } ?> >
...
<script>
	...
	function cargarDatosAct(id_cliente,id_centro_costo,id_cargo){
		...
		"id_centro_costo" : id_centro_costo
	      ...
	      $.ajax({
                  ...
                  url:   '../Controlador/listarCargosClienteActualizar.php',
	...
	cargarDatosAct(<?php echo $datos[0]['id_cliente'];?>,<?php echo $datos[0]['id_perfil'];?>,<?php echo $datos[0]['id_cargo'];?>);
    </script>
</body>
</html>