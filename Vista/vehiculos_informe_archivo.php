<?php
$filename = 'informeFlotaPropia.xls';
...
<table  id="dataT" class="table table-hover table-sm display tablesaw tablesaw-columntoggle" data-tablesaw-mode="columntoggle" data-tablesaw-minimap style="width:100%">
              ...
              <!--INICIO CONDUCTORES-->
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">NOMBRE CONDUCTOR</th>
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">N° DOCUMENTO</th>
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">FECHA NACIMIENTO</th>
              ...
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">TELEFONO 2</th>
              <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">TELEFONO 3</th>
              <!--FIN CONDUCTORES-->
