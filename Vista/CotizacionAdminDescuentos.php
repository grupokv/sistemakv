...
$listar = $cotizadorkv->listarDescuentos();
?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>SistemaKV | Descuentos</title>
...
<section class="home_content">
    ...
    <div class="notice notice-sistemakv">
        <strong>
            <i class="fa fa-build mr-3" style="font-size: 2rem;"></i><b style="font-size:1.3rem;">DESCUENTOS</b>
        </strong>
    </div>
    
    <div class="notice notice-sistemakv">
        <a id="buttonsKV" href="CotizadorAdminDescuentosNew.php" class="btn ml-1 mr-1">Nuevo Descuento <i class="fa fa-plus-circle ml-1"></i></a>
    </div>
    	...
    	<table id="dataT" class="table table-hover table-sm display tablesaw tablesaw-columntoggle" data-tablesaw-mode="columntoggle" data-tablesaw style="width:100%">
    		...
    		<tbody class="text-center">
                <?php foreach ($listar as $lu){ ?>
                    <tr>
                        <td><?php echo $lu['id_descuento'] ?></td>
                        <td><?php echo $lu['valor'] ?></td>
                        <td>
                            <a href="CotizadorAdminDescuentosEdit.php?id_descuento=<?php echo base64_encode($lu['id_descuento']) ?>" class="btn btn-outline-info"  style="margin: 0px; padding: 0px 4px 0px 4px;">
                                <span class="fa fa-edit"></span>
                            </a>
                            <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#modalDelete" style="margin: 2px; padding: 0px 4px 0px 4px;" onclick="borrar_registro(<?php echo $lu['id_descuento'];?>)"><i class="fa fa-close"></i></button>
                        </td>
                </tr>
                <?php } ?>
    		</tbody>
          ...
          <div class="modal-dialog " role="document">
            <div class="modal-content f-flex justify-content-center">
              ...
              <div class="modal-footer">
                  <form action="../Controlador/borrarDescuentoCotizador.php" method="post">
