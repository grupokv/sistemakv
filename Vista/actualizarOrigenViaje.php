...
$titulo = 'Actualizar Origen';
$redireccion = 'origen_viaje.php';
$icono = 'fa fa-map';

$id = $_GET['id'];
$viaje = new Viaje();
$datos = $viaje->listarOrigenPorId($id);
...
<body>
    ...
    <div aria-label="breadcrumb" class="mt-1"> 
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Actualizar Origen</li>
         </ol>
    </div>

    <section class="form-usuarios">
        <div class="formulario mb-5">
            <form action="../Controlador/actualizarOrigenViaje.php" method="POST">
