...
$listado = $encuesta->listarRespuestasPorIdPregunta($id_pregunta);
...
<body>
    ...
    <div aria-label="breadcrumb" class="mt-1"> 
         <ol class="breadcrumb">
			...
			<li class="breadcrumb-item " aria-current="page"><a href="preguntasEncuesta.php?id=<?php echo $id_encuesta;?>">Preguntas</a></li>
    ...
    <div class="row barra-principal">
      	...
      	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 titulo_principal">
      		  <h2 class="mt-2" style="color: #fff; line-height: 25px;"><span class="fa fa-pencil-square-o icono-principal ml-2" style="border: 2px solid #fff; border-radius: 50%;  font-size:0.8em; padding: 9px;"></span> Respuestas Encuesta</h2>
      	</div>
      	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 botones_principal">
      		<?php if($permisos[0]['agregacion'] == 1){ ?>
            <a href="nuevaRespuesta.php?datos=<?php echo $datos;?>" class="btn boton-registro ml-1 mr-1"><span class="fa fa-plus ml-2 mr-2"></span>Nueva Respuesta</a>
        	<?php } ?>
        </div>
    </div>
      ...
      <div class="mt-2 p-4 table-responsive">
    	  <table  id="dataT" class="table table-hover table-sm display" style="width:100%">
            ...
            <?php foreach ($listado as $lv){ ?>
              <tr>
                  <td><?php echo $lv['id_respuesta']; ?></td>
                  <td><?php echo $lv['detalle']; ?></td>
				  <td>
				  <?php if($lv['ampliacion'] == 'S'){ echo "SI"; } else { echo "NO"; } ?>
				  </td>
				  <td><?php echo $lv['orden']; ?></td>
                  <td>
                        
					<!-- Actualizar -->
					<?php if($permisos[0]['edicion'] == 1){ ?>
						<?php $datos2 = $datos.'_'.$lv['id_respuesta']; ?>
                          <a href="actualizarRespuesta.php?id=<?php echo $datos2; ?>" class="btn btn-outline-info"  style="margin: 0px; padding: 0px 4px 0px 4px;"><span class="fa fa-edit"></span></a>
                         <?php } ?>
