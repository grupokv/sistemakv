...
$redireccion = 'administrarServiciosProgramacion.php';
...
<body>  
        ...
        <section class="form-usuarios mt-1">
            <div class="formulario mb-5">
    	        <form action="../Controlador/actualizarRutaServicioProgramacion.php" method="POST" name="formulario_registro" id="formulario_registro">
                    <?php include("Template/header-form.php"); ?>
                        ...
                        <?php foreach ($listar_programacion_serviciosID as $lpsID){ ?> 
                            ...
                            <!--FECHA SERVICIO -->
                                ...
                                <div class="row mt-3" style="width: 100%;">
                                    ...
                                    <div class="input">
                                        <input type="text" name="fecha" id="fecha" class="form-control" value="<?php echo $lpsID['fecha']; ?>"> 
                                    </div> 
                                </div>  
                        ...
                        <!-- PUNTO FINAL -->
                            ...
                            <div class="row mt-3" style="width: 100%;">
                                ...
                                <div class="input">
                                    <!-- <textarea name="novedades" id="novedades" class="form-control"><?php echo $lpsID['novedades']; ?></textarea> -->
                                    <select name="" id="" class="form-control selectpicker" data-live-search="true" onchange="validarOpcion(this.value);">
                                        <option value="">SELECCIONAR</option>
                                        <option value="">RELEVO MONITORA</option>
                                        <option value="">RELEVO VEHÍCULO</option>
                                        <option value="">CANCELACIÓN SERVICIO</option>
                                        <option value="">LLEGADA TARDE</option>
                                        <option value="">VARADO</option>
                                        <option value="">ABANDONO DE RUTA</option>
                                        <option value="">CAMBIO DE FRECUENCIA</option>
                                        <option value="">CAMBIO DE HORARIO</option>
                                        <option value="">CAMBIO DE CAPACIDAD</option>
                        ...
                        <!-- PUNTO FINAL -->
                            ...
                            <div class="row mt-3" style="width: 100%; display: none;" id="otrosNov">
                                <div class="label">
                                    <label>Otros</label>
                                </div>
                                <div class="input">
                                    <textarea name="otros_novedades" id="otros_novedades" class="form-control"></textarea>
                                </div> 
                            </div>
                        ...
                        <!-- VALOR A PAGAR -->
                            <div class="row  mt-3 " style="width: 100%;">
                                ...
                                <div class="input">
                                    <input type="text" name="valor_pagar" id="valor_pagar" class="form-control" value="<?php echo $lpsID['valor_pagar']; ?>">
                                </div>              
                            </div>
                        ...
                        <!-- VALOR A PAGAR MONITORA -->
                            <div class="row  mt-3 " style="width: 100%;">
                                ...
                                <div class="input">
                                    <input type="text" name="valor_pagar_monitora" id="valor_pagar_monitora" class="form-control" value="<?php echo $lpsID['valor_pagar_monitora']; ?>">
                                </div>              
                            </div>
                            ...
                            <div class="row  mt-3 " style="width: 100%;">
                                ...
                                <div class="input">
                                    <select name="estado" id="estado" class="form-control">
                                        <option value="">SELECCIONAR</option>
                                        <option value="A" <?php if($lpsID['estado'] == 'A'){ ?> selected="selected" <?php } ?> style="color: green;">ACTIVO</option>
                                        <option value="C" <?php if($lpsID['estado'] == 'I'){ ?> selected="selected" <?php } ?> style="color: #f5c127;">CANCELADO</option>
                                    </select>
                                </div>              
                            </div>
    ...
    <script type="text/javascript">
        ...
        function validarOpcion(val){
            if (val == 'OTROS') {
                document.getElementById('otrosNov').style.display = 'flex';
            }else{
                document.getElementById('otrosNov').style.display = 'none';
            }
        }
