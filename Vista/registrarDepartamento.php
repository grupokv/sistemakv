...
<head>
    <meta charset="utf-8">
	<title>SistemaKV | Registrar Departamento</title>
    ...
    <!-- CONTENIDO -->
        ...
        <section class="home_content"> 
            ...
            <div class="notice notice-sistemakv">
                <strong><i class="fa fa-map mr-2" style="font-size: 2rem;"></i><b style="font-size: 1.2rem;">REGISTRAR DEPARTAMENTO</b></strong>
            </div>

            <section class="form-usuarios">
                <div class="formulario mb-5">
        	        <form action="../Controlador/registrarDepartamento.php" method="POST">
                        ...
                        <!-- PAIS -->
                            <div class="row mt-3 mb-4">
                                ...
                                <div class="input">
                                    <select name="id_pais" id="id_pais" required="required" class="form-control selectpicker" data-live-search="true">
                        ...
                        <!--NOMBRE CIUDAD-->
                            <div class="row mt-3 mb-4">
                                ...
                                <div class="input">
                                    <input type="text" name="nombre_departamento" id="nombre_departamento" class="form-control" required="required">
                                </div>
                            </div>
                        ...
                        <!-- BOTONES -->
                            ...
                            <section class="col-12 mt-5 d-flex justify-content-center">
                                ...
                                <!-- CANCELAR REGISTRO -->
                                    <a href="departamentos.php" class="btn btn-outline-danger col-xs-12 col-sm-12 col-md-3 mr-3">Cancelar</a>
