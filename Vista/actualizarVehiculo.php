			        ...
			        <form action="../Controlador/actualizarVehi.php" method="POST" enctype="multipart/form-data" onsubmit="return validar()">
		                ...
		                <?php foreach ($listarVehiId as $lvi){ ?>
				                    ...
				                    <div id="tabs-1">
										...
										<!-- TIPO DE AFILIACIÓN -->
                                            ...
                                            <input type="hidden" name="tipo_afiliacion_act" id="tipo_afiliacion_act" value="<?php echo $lvi['tipo_afiliacion']; ?>">
                                                ...
                                                <div class="row m-3 p-3" id="campo_externo" style="border: 1px dashed #d3d3d3; border-radius:5px;<?php if($lvi['tipo_afiliacion'] != 'TERCERO'){?> display:none; <?php } ?>" >
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <label>Nombre Empresa</label>
                                                        <input type="text" name="otra_empresa_afiliada" id="otra_empresa_afiliada" class="form-control form-control-sm" placeholder="Razon Social" value="<?php echo $lvi['empresa_afiliada']; ?>">
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <label>NIT Empresa Afiliada</label>
                                                        <input type="text" name="nit_otra_empresa_afiliada" id="nit_otra_empresa_afiliada" class="form-control form-control-sm" placeholder="NIT" value='<?php echo $lvi['nit_empresa_afiliada']; ?>'>     
                                                    </div>
                                                </div> 

                                                <div class="row m-3 p-3" id="campo_afiliado" style="border: 1px dashed #d3d3d3; border-radius:5px;<?php if($lvi['tipo_afiliacion'] != 'AFILIADO') { ?> display:none; <?php } ?>">
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        ...
                                                        <select name="empresa_afiliada" id="empresa_afiliada" class="form-control form-control-sm selectpicker" data-live-search="true" title="SELECCIONAR">
                                                            <option value="ORT" <?php if($lvi['empresa_afiliada'] == 'ORT'){ ?> selected="selected" <?php } ?> >ORT</option>
                                                            <option value="LP" <?php if($lvi['empresa_afiliada'] == 'LP'){ ?> selected="selected" <?php } ?> >LINEAS PREMIUM</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <label>NIT Empresa Afiliada</label>
                                                        <input type="text" name="nit_empresa_afiliada" id="nit_empresa_afiliada" class="form-control form-control-sm" placeholder="NIT" readonly="readonly"  value='<?php echo $lvi['nit_empresa_afiliada']; ?>'>     
                                                    </div>
                                                </div>   
                                        ...
                                        <!-- TIPO COMBUSTIBLE -->
											<div class="row mt-3">
			                    		       	...
			                    		       	<div class="input">
                                                    ...
                                                    <option value="<?php echo $tipocom['detalle'];?>" <?php if($lvi['tipo_combustible'] == $tipocom['detalle']) { ?> selected="selected" <?php } ?> ><?php echo $tipocom['detalle'];?></option>
                                                    <?php } ?>
                                                    </select>
                                            ...
                                            <div class="row m-3 p-3" style="border: 1px dashed #d3d3d3; border-radius:5px;">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    <?php if ($lvi['fecha_exp_disp_velocidad'] <= $plazoVencimiento2){ ?>
                                                        ...
                                                        <input type="text" value="<?php echo $lvi['fecha_exp_disp_velocidad'] ?>" name="fecha_exp_disp_velocidad" id="fecha_exp_disp_velocidad" class="form-control form-control-sm" style="border: 2px solid red;">
                                                    <?php }else { ?>
		                    ...
		                    <section class="col-12 mt-4 d-flex justify-content-center">
		                        ...
		                        <?php if(($permisos[0]['edicion'] == 1)or(($_SESSION['id_perfil'] == 2)or($_SESSION['id_perfil'] == 3)or($_SESSION['id_perfil'] == 8))){ ?>
