...
$hoy = date('Y-m-d');
$datos_contrato = $contrato->listarPorClienteActivo($_SESSION['id_cliente'],$hoy);
$num_contrato = $datos_contrato[0]['id_contrato'];

$listarTodosVehiculos = $veh_con->listarPorContrato($num_contrato);
...
if($_POST){
	if($id_vehiculo == '%%'){	  
		$id_vehiculo = '';	  
		$listado_veh = $veh_con->listarPorContrato($num_contrato);	  
...
<body>
    ...
    <div class="row barra-principal">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 titulo_principal">
              <h2 class="mt-2" style="color: #fff; line-height: 25px;"><span class="fa fa-file-text-o icono-principal ml-2" style="border: 2px solid #fff; border-radius: 50%;  font-size:0.8em; padding: 9px;"></span> Preoperacionales</h2>
        </div>
