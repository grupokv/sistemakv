...
/* VARIABLES MENU*/
$titulo = 'Registrar Polizas';
$redireccion = 'polizas_cartera.php';
$icono = 'fa fa-gears';
...
<body>
	...
	<div aria-label="breadcrumb" class="mt-1"> 
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item " aria-current="page"><a href="perfiles.php">Polizas</a></li>
            <li class="breadcrumb-item active" aria-current="page">Registrar Polizas</li>
         </ol>
    </div>

    <section class="form-usuarios">
        <div class="formulario mb-5">
	        <form action="../Controlador/registrarPolizasCartera.php" method="POST">
