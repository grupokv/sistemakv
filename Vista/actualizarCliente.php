    ...
    <!-- CONTENIDO -->
	    <section class="home_content">  
	        ...
	        <div class="notice notice-sistemakv">
	            <strong><i class="fa fa-briefcase mr-3" style="font-size: 2rem;"></i>ACTUALIZAR CLIENTE</strong>
	        </div>
		    ...
		    <section class="form-usuarios mt-1 mb-4">
		        <div class="formulario mb-3">
                    <!--FORMULARIO -->
        	            ...
        	            <form method="POST" action="../Controlador/actualizarCliente.php">
            	        	...
            	        	<div id="tabs" class="mt-3">
        			            ...
        			            <div id="tabs-1">
        				            ...
        				            <!-- Razon Social-->
        			                    <div class="row mt-3">
        			                    	...
        			                    	<section class="input">
        	                                        <input type="text" name="sigla" id="sigla" class="form-control" value="<?php echo $datos[0]['sigla']; ?>">
        	                                        <input type="hidden" name="sigla_act" id="sigla_act" class="form-control" value="<?php echo $datos[0]['sigla']; ?>">
        					     	        </section>
        			                    </div>
        		                    ...
        		                    <!-- Correo Eletrónico -->
        			                    ...
        			                    <div class="row mt-3">
        			                    	...
        			                    	<section class="input">
        							     	    <input type="email" name="correo_electronico" id="correo_electronico" class="form-control" value="<?php echo $datos[0]['correo_electronico'];?>">
        							     	    <input type="hidden" name="correo_electronico_act" id="correo_electronico_act" class="form-control" value="<?php echo $datos[0]['correo_electronico'];?>">
        					     	        </section>
        			                    </div>
        			                    	...
        			                    	<section class="input">
        							     	    <select name="tipo_cliente" id="tipo_cliente" class="form-control">
        									        ...
        									        <?php foreach ($segmentos as $sg){ ?>
        									        	<option value="<?php echo $sg['id_segmento'] ?>" <?php if ($datos[0]['id_segmento'] == $sg['id_segmento']){ ?> selected="selected" <?php } ?> >
        									        		<?php echo $sg['detalle'] ?>
        									        	</option>
        									        <?php } ?>
        									    </select>
        									    <input type="hidden" name="tipo_cliente_act" id="tipo_cliente_act" class="form-control" value="<?php echo $datos[0]['id_segmento'];?>">
        									 </section>
        			                    </div>
        	                    ...
        	                    <div id="tabs-2">
        			                ...
        			                <!-- Ciudad Residencia Representante Legal-->
        			                ...
        			                <!-- Ciudad Expedicion Representante Legal-->
        								<div class="row  mt-3">
        			                    	<section class="label">
