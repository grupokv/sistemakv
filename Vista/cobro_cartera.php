...
$listado = $cartera->listarCobroCartera();
...
<head>
  <meta charset="utf-8">
  <title>SistemaKV | Cobro Cartera</title>
...
<body>
    ...
    <section class="home_content">  
        ...
        <div class="notice notice-sistemakv">
            <strong><i class="fa fa-dollar mr-2" style="font-size: 2rem;"></i><b style="font-size: 1.2rem;">COBRO CARTERA</b></strong>
        </div>
        ...
        <div class="modal fade" id="pagos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">                                  
            <div class="modal-dialog modal-xl" role="document">                                    
                <div class="modal-content f-flex justify-content-center">   
                    ...
                    <div class="modal-footer">
                        <a href="javascript:void(0)" id="vehSinAcuerdo" title="Nuevo Comprobante Sin Acuerdo" data-dismiss="modal" data-toggle="modal" data-target="#comprobante_sin" onclick="cargarComprobanteSinAcuerdo(this.value)">
                            <button type="button" class="btn btn-outline-info" >Cargar Comprobante Sin Acuerdo</button>
                        </a>
                        <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cerrar</button>    
                    </div>                                    
                </div>                                  
    ...
    <!-- CARGAR COMPROBANTE PAGO SIN ACUERDO-->
        <div class="modal fade" id="comprobante_sin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">                                  
            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">                                    
                <div class="modal-content f-flex justify-content-center">   
                    <div class="modal-header">                                        
                      <h5 class="modal-title" id="exampleModalLabel">CARGAR COMPROBANTE PAGO SIN ACUERDO</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>                                      
                    </div>   
                    <form action="../Controlador/guardarComprobantePagoSinAcuerdoCartera.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">                                         
                        <section id="contenido_modal_cargar_comprobante_sin_acuerdo" >   
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="id_veh_comprobante" id="id_veh_comprobante" />
                        <button type="submit" class="btn btn-outline-success">Guardar</button>
                        <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cerrar</button>    
                    </div>
                    </form>
    ...
    <script type="text/javascript">
        ...
        function modalPagos(id_vehiculo){
            document.getElementById('vehSinAcuerdo').value = id_vehiculo;
            var parametros = {
                "id_vehiculo" : id_vehiculo
            };
            $.ajax({
        ...
        function cargarComprobanteSinAcuerdo(val){
            document.getElementById('id_veh_comprobante').value = val;
        }
    </script>
