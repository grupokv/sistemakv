...
$actualizar = $cotizacion->registrarDestino($ciudad, $departamento, $dias, $kilometraje, $kms, $peajes, $peaje_campero, $valor_campero, $peaje_doblecabina, $valor_doblecabina, $peaje_van, $valor_van, $peaje_microbus, $valor_microbus, $peaje_buseta, $valor_buseta, $peaje_buseton, $valor_buseton, $peaje_bus, $valor_bus);

echo ("<script LANGUAGE='JavaScript'>
    window.alert('Destino Creado Correctamente');
