...
$html .= '<div class="row mt-3 ">';
	$html .= '<section class="label">';
	 	$html .= '<label>Fecha de Pago</label>';
	$html .= '</section>';
	$html .= '<section class="input">';
	 	$html .= '<input type="text" name="fecha_pago" id="datepicker" class="form-control" required="required" onblur="comparar()">';
	$html .= '</section>';
$html .= '</div>';

$html .= '<div class="row mt-3 " id="fechaFinal">';
	$html .= '<section class="label">';
         $html .= '<label>Valor Pagado </label>';
     $html .= '</section>';
	$html .= '<section class="input">';
         $html .= '<input type="text" name="valor_pago" id="valor_pago" class="form-control" required="required" onblur="comparar()">';
         $html .= '<input type="hidden" name="diferencia_valores" id="diferencia_valores" class="form-control" />';
     $html .= '</section>';
$html .= '</div>';

$html .= '<div class="row mt-3" id="ciudad">';
	$html .= '<section class="label">';
         $html .= '<label>Banco donde consigno</label>';
     $html .= '</section>';
	$html .= '<section class="input">';
 	    $html .= '<select class="form-control" name="id_cuenta" id="id_cuenta" required="required" onchange="comparar()">';
 	    	$html .= '<option value="0">Seleccionar</option>';
		 	foreach ($bancos as $bn){
		 		$html .= '<option value="' . $bn["id_cuenta"] . '">' . $bn['descripcion'] .'</option>';
		 	}
		$html .= '</select>';
     $html .= '</section>';
$html .= '</div>';
...
$html .= '<div class="row mt-3">';
	$html .= '<section class="label">';
         $html .= '<label>Comprobante</label>';
    $html .= '</section>';
	$html .= '<section class="input">';
		$html .= '<input type="file" name="comprobante" id="comprobante" class="form-control" onchange="comparar(); required">';
    $html .= '</section>';
$html .= '</div>';

$html .= '<div class="row mt-3" id="total_diferencia" style="display:none;">';
	$html .= '<section class="label">';
        $html .= '<label>Valor de diferencia</label>';
    $html .= '</section>';
	$html .= '<section class="input">';
		$html .= '<input name="diferencia" id="diferencia" class="form-control" value="" readonly="readonly"/>';
    $html .= '</section>';
$html .= '</div>';

$html .= '<div class="row mt-3" id="detalle_diferencia" style="display:none;">';
	$html .= '<section class="label">';
        $html .= '<label>Detalle de la diferencia de valores</label>';
    $html .= '</section>';
	$html .= '<section class="input">';
		$html .= '<textarea name="detalle" id="detalle" class="form-control"></textarea>';
    $html .= '</section>';
$html .= '</div>';
