...
$registrarTemaActa = $acta->registrarTemaActa($id_acta, $nombre_tema, $descripcion_tema);
	...
	<div class="row" style="background: #fff; width: 50%; height: 170px; border-radius: 2px;">
		<section class="col-8">
			<div class="row justify-content-center mt-4">
				...
				<p style="font-family: 'Raleway', sans-serif;">¿Deseas agregar otro tema para este acta?</p>
            </div>
		</section>
		<section class="col-4" style="border-left: 4px solid #eee">
			<div class="mt-5">
				<a href="../Vista/registrarActasTemas.php?id_acta=<?php echo $id_acta ?>" type="button" class="btn btn-block" id="registrar" style="border: 1px solid  #18ad13; border-radius: 18px; color:  #18ad13;  ">Agregar Mas</a>
				<a href="../Vista/registrarActasSituaciones.php?id_acta=<?php echo $id_acta ?>" type="button" class="btn btn-block" id="continuar" style="border: 1px solid #c40c0c; border-radius: 18px; color: #c40c0c; ">Continuar</a>
			</div>
		</section>
	</div>
</div>
