...
for ($i=0; $i < count($fechas); $i++) { 
   ...
   // $datossolicitud = $programacion->solicitudPorId($id_solicitud);
	...
	$registrarAsignacionDeServicio = $programacion->registrarAsignacion($id_servicio, $id_contrato, $id_proyecto, $id_tarifa_proyecto, $id_vehiculo, $id_conductor, $estado, $fecha, $tipo, $costo);
