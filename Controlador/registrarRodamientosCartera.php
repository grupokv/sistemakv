...
$registrarRodamientosCartera = $cartera->registrarRodamientosCartera($id_empresa, $nombre_cliente, $tipo_identificacion, $num_identificacion, $valor_total, $por_vencer, $dias_mora_1_30, $dias_mora_31_60, $dias_mora_61_90, $dias_mora_mayor_90, $id_usuario_creador, $fecha_creacion);
	...
	<div class="row" style="background: #fff; width: 50%; height: 170px; border-radius: 2px;">
		<section class="col-8">
			<div class="row justify-content-center mt-4">
				...
				<p class="col-12 text-center" style="font-family: 'Raleway', sans-serif;">Se ha registrado correctamente el rodamiento</p>
		...
		<section class="col-4" style="border-left: 4px solid #eee">
			<div class="mt-5">
				<a href="../Vista/registrarRodamientos.php" type="button" class="btn btn-block" id="registrar" style="border: 1px solid  #18ad13; border-radius: 18px; color:  #18ad13;  ">Registrar</a>
				<a href="../Vista/rodamientos_cartera.php" type="button" class="btn btn-block" id="continuar" style="border: 1px solid #c40c0c; border-radius: 18px; color: #c40c0c; ">Finalizar</a>
			</div>
		</section>
	</div>
</div>
