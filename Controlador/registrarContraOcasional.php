...
$registrarCO = $contratoOcasional->registrarContratoOcasional($objeto_contrato, $id_empresa, $id_cliente, $id_vehiculo, $origen, $destino, $id_ciudad, $fecha_inicial_contrato_ocasional, $fecha_final_contrato_ocasional, $fecha_creacion, $hora_creacion, $valor_contrato, $id_responsable, $estado);
...
/*echo $url = '../Resources/fuec/phpbarcode39/img_barcode39.php?id_fuecOcasional=' . $registrarFuecO;
...
<script>
//alert( <?php echo $registrarFuecO ?>);
    window.location.href = "../Resources/fuec/phpbarcode39/img_barcode39.php?id_fuecOcasional=" + <?php echo $registrarFuecO ?>
</script>
