...
$id = $_POST['id'];
$salud = new Salud();
$listarConId = $salud->listarPorIdVulnerabilidad($id);
...
if($cant > 0){
	foreach($listarConId as $lci){
		...
		$html .= '<tr><td><strong>Otra enfermedad:</strong></td><td>'.$lci['otra_enfermedad'].'</td></tr>';
		$html .= '<tr><td><strong>Cual:</strong></td><td>'.$lci['cual'].'</td></tr>';
		$html .= '<tr><td><strong>Ninguna:</strong></td><td>'.$lci['ninguna'].'</td></tr>';
		$html .= '<tr><td colspan="2"><hr/></td></tr>';
		$html .= '<tr><td><strong>Actualmente esta en estado de embarazo:</strong></td><td>'.$lci['embarazo'].'</td></tr>';
		$html .= '<tr><td><strong>Sufre de obesidad:</strong></td><td>'.$lci['obesidad'].'</td></tr>';
