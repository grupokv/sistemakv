...
$id = $_POST['id'];
$nombre_entrega = $_POST['nombre_recibe'];
...
$actualizar = $inspeccionVehicular->guardarFirmaRecibe($id,$nombre_archivo,$nombre_entrega);    
if($actualizar > 0){
    echo ("<script LANGUAGE='JavaScript'>
    window.alert('Firma de Recibido Realizada Correctamente');
