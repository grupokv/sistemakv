...
$registrar = $cotizadorkv->guardar_destino($nombre, $kms, $dias_viaje, $valor_4_pax, $valor_19_pax, $valor_24_pax, $valor_30_pax, $valor_40_pax, $valor_45_pax, $cant_peajes, $estado);
