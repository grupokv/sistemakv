        ...
        if ($login) {
          ...
          $actualizarUltimoIngreso = $objUsuario->actualizarUltimoIngreso($_SESSION['id_usuario'], $login[0]['cant_ingresos'] + 1 , date('Y-m-d H:i:s'));
            ...
            if ($login[0]['estado'] == 0) {
                ...
                echo ("<script LANGUAGE='JavaScript'>window.location.href='Vista/CambiarEstadoComprobacionCobroPropietario.php?estadoBoton=" . $_GET['estadoBoton'] . "&id_comprobante=" . $_GET['id_comprobante'] . "';</script>");
            }
        }else{
