                          ...
                          <div class="row contenedorForm mt-3" id="contenedorForm">
                              <div  class="col-md-12" id="duplicarCampos">
                                  ...
                                  <section class="row"  style="margin-top: 15px; margin-left: 70px;">
                                       ...
                                       <div class="col-md-5">
                                          <input type="date" name="fecha_limite[]" id="datepicker" class="form-control">
                                       </div>
                                  </section>   
                                <div style="display: flex; justify-content: center;">
                                    <section style="width: 85%; height: 3px; background-color: #ddd; margin-top: 45px; margin-bottom: 45px;"></section>
                                </div>
                              </div>
  ...
  <script src="../Recursos/js/fullcalendar.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function duplicar(){
            ...
            clon.attr("id", 'duplicarCampos' + '_' + num);
        ...
        function eliminar(){
            ...
            document.getElementById('duplicarCampos_'+(num - 1)).remove();
            num--;    
